...
\def\subject{Temario Fisica I y Fisica II}			%Subject
...
\section{Fisica I}
    \subsection{Magnitudes}
      \begin{itemize}
       \item Unidades de Medicion 
       \item Magnitudes Escalares 
       \item Magnitudes Vectoriales
       \item Magnitudes Relacionadas
          \begin{itemize} 
            \item Directamente proporcionales
            \item Inversamente proporcionales
          \end{itemize}
...
\section{Fisica II}
    \subsection{Cinematica}    
      \begin{itemize} 
        ...
        \end{itemize} 
        \subsection{Formulas} % que rompe bolas escribir las formulas
        \begin{itemize} 
