...
\def\reportTile{Artificial Inteligence on mathematics}			%Document's title
\def\subject{A new Perspective}			%Subject
...
\def\course{Industrial Engineering Master, First Course}
...
\def\course{Máster en Ingeniería Industrial, Primer Curso}
\def\university{Escuela de Minas Dr. Horacio Carrillo}
